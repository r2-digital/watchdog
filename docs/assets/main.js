'use strict';
'use strict';
(()=>{let Ce=Object.create;let ne=Object.defineProperty;let Pe=Object.getOwnPropertyDescriptor;let Oe=Object.getOwnPropertyNames;let _e=Object.getPrototypeOf; var Re=Object.prototype.hasOwnProperty;let Me=(t,e)=>()=>(e||t((e={
exports:{
}
}).exports,e),e.exports);let Fe=(t,e,n,r)=>{if(e&&typeof e==="object"||typeof e==="function")for(const i of Oe(e))!Re.call(t,i)&&i!==n&&ne(t,i,{
get:()=>e[i],enumerable:!(r=Pe(e,i))||r.enumerable
});return t};let De=(t,e,n)=>(n=t!=null?Ce(_e(t)):{
},Fe(e||!t||!t.__esModule?ne(n,'default',{
value:t,enumerable:!0
}):n,t));let ae=Me((se,oe)=>{(function(){let t=function(e){let n=new t.Builder;return n.pipeline.add(t.trimmer,t.stopWordFilter,t.stemmer),n.searchPipeline.add(t.stemmer),e.call(n,n),n.build()};t.version='2.3.9';t.utils={
},t.utils.warn=function(e){return function(n){e.console&&console.warn&&console.warn(n)}}(this),t.utils.asString=function(e){return e==null?'':e.toString()},t.utils.clone=function(e){if(e==null)return e;for(var n=Object.create(null),r=Object.keys(e),i=0;i<r.length;i++){let s=r[i]; var o=e[s];if(Array.isArray(o)){n[s]=o.slice();continue}if(typeof o==="string"||typeof o==="number"||typeof o==="boolean"){n[s]=o;continue}throw new TypeError('clone is not deep and does not support nested objects')}return n},t.FieldRef=function(e,n,r){this.docRef=e,this.fieldName=n,this._stringValue=r},t.FieldRef.joiner='/',t.FieldRef.fromString=function(e){let n=e.indexOf(t.FieldRef.joiner);if(n===-1)throw'malformed field ref string';let r=e.slice(0,n); var i=e.slice(n+1);return new t.FieldRef(i,r,e)},t.FieldRef.prototype.toString=function(){return this._stringValue==null&&(this._stringValue=this.fieldName+t.FieldRef.joiner+this.docRef),this._stringValue};t.Set=function(e){if(this.elements=Object.create(null),e){this.length=e.length;for(let n=0;n<this.length;n++)this.elements[e[n]]=!0}else this.length=0},t.Set.complete={
intersect:function(e){return e},union(){return this},contains(){return!0}},t.Set.empty={
intersect:function(){return this},union(e){return e},contains(){return!1}},t.Set.prototype.contains=function(e){return!!this.elements[e]},t.Set.prototype.intersect=function(e){let n; var r; var i; var s=[];if(e===t.Set.complete)return this;if(e===t.Set.empty)return e;this.length<e.length?(n=this,r=e):(n=e,r=this),i=Object.keys(n.elements);for(let o=0;o<i.length;o++){let a=i[o];a in r.elements&&s.push(a)}return new t.Set(s)},t.Set.prototype.union=function(e){return e===t.Set.complete?t.Set.complete:e===t.Set.empty?this:new t.Set(Object.keys(this.elements).concat(Object.keys(e.elements)))},t.idf=function(e,n){let r=0;for(let i in e)i!='_index'&&(r+=Object.keys(e[i]).length);let s=(n-r+.5)/(r+.5);return Math.log(1+Math.abs(s))},t.Token=function(e,n){this.str=e||'',this.metadata=n||{
}},t.Token.prototype.toString=function(){return this.str},t.Token.prototype.update=function(e){return this.str=e(this.str,this.metadata),this},t.Token.prototype.clone=function(e){return e=e||function(n){return n},new t.Token(e(this.str,this.metadata),this.metadata)};t.tokenizer=function(e,n){if(e==null||e==null)return[];if(Array.isArray(e))return e.map(function(y){return new t.Token(t.utils.asString(y).toLowerCase(),t.utils.clone(n))});for(var r=e.toString().toLowerCase(),i=r.length,s=[],o=0,a=0;o<=i;o++){let l=r.charAt(o); var u=o-a;if(l.match(t.tokenizer.separator)||o==i){if(u>0){let d=t.utils.clone(n)||{
};d.position=[a,u],d.index=s.length,s.push(new t.Token(r.slice(a,o),d))}a=o+1}}return s},t.tokenizer.separator=/[\s\-]+/;t.Pipeline=function(){this._stack=[]},t.Pipeline.registeredFunctions=Object.create(null),t.Pipeline.registerFunction=function(e,n){n in this.registeredFunctions&&t.utils.warn('Overwriting existing registered function: '+n),e.label=n,t.Pipeline.registeredFunctions[e.label]=e},t.Pipeline.warnIfFunctionNotRegistered=function(e){let n=e.label&&e.label in this.registeredFunctions;n||t.utils.warn(`Function is not registered with pipeline. This may cause problems when serialising the index.
`,
                            e,
                        );
                }),
